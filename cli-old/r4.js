...
args
	...
	.command(
		['init'],
		'Init the current folder as r4 folder, with a default channel'
	)
	...
	.example(
		'r4 init a-channel',
		`Init the current folder as a Radio4000 folder with the channel "a-channel" as default`
	)
	.example(
		'r4 clean a-channel',
		`Clean all unecessary files in the ./a-channel channel folder`
	)
